...
public class EntitiesRelatedEntitiesAsyncLoader {
    ...
    public static List<EntityId> findEntities(TbContext ctx, EntityId originator,
                                                                     RelationsQuery relationsQuery) throws ExecutionException, InterruptedException {
        ...
        ListenableFuture<List<EntityRelation>> asyncRelation = relationService.findByQuery(ctx.getTenantId(), query);
            ...
            throw new InterruptedException("Unknown direction");
    }
